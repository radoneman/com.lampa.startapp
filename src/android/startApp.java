...
public class startApp extends Assets {
    ...
    /**
     * Listen for boardcasted messages
     *
     * @param args
     * @param callback
     */
            ...
            if (args.get(0) instanceof JSONObject) {
                ...
                if (!args.isNull(1)) {
                    ...
                    while (iter.hasNext()) {
                        ...
                        // extra params is an array
                        if (value instanceof JSONArray) {
                            JSONArray val = new JSONArray(extra.getString(key));
                            ArrayList<String> list = new ArrayList<String>();
                            for (i = 0; i < val.length(); i++) {
                                list.add(val.getString(i));
                            }
                            LaunchIntent.putExtra(parseExtraName(key), list);
                        // int
